...
Component stats have ranges because Railjack parts use the same Valence Fusion system as adversary weapons. Check out the [Valence Fusion](valence.md) guide for tips on maxing gear in the fewest fusions. When valence fusing Railjack parts, parts do not need to be of the same tier or fully repaired first. You can fuse scrap parts to built ones at 40% crafting cost, and lower tier parts can be fused for a smaller fusion percentage gain.
...
--8<-- "railjack/rj-shield-stats.html"

--8<-- "railjack/rj-shield-array.html"
...
--8<-- "railjack/rj-engines-stats.html"

--8<-- "railjack/rj-engines.html"
...
--8<-- "railjack/rj-reactor-stats.html"
...
<figure class="guide-text-image__img" style="flex: 0 0 40%;">
  <img src="../../images/railjack/on-call.webp" alt="My on-call">
</figure>
</div>
...
![My Kuva Zarr](../images/affinity-farming/on-call-gear.webp){ .center .bordered .floored width=70% }
