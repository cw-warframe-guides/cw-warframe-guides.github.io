...
# Modding: A Checklist for Melees
...
<ol start="0">
<li>What Type of Weapon/Build Are You Using?</li>
<li>What's My Stance?</li>
<li>Condition Overload or No?</li>
<li>Do I Need Attack Speed?</li>
<li>Is It a Combo Build?</li>
<li>Is It a Viable Crit Weapon?</li>
<li>Is It a Viable Status Weapon?</li>
<li>What QoL Mods Should I Use?</li>
</ol>
...
Same rule of thumb as guns, a good status melee has over 15-20% status chance. Status viability determines three things for melee:
- Whether to run 60/60 mods like Virulent Scourge or 90% elementals like Molten Impact
- Whether to run Weeping Wounds
- Whether to run Elementalist mods
...
![Nikana Prime Basic](../images/modding/meleechk-nikana-basic.webp){ .center .bordered .floored width=80% }
...
![Nikana Prime SP](../images/modding/meleechk-nikana-sp.webp){ .center .bordered .floored width=80% }
...
![Xoris Build](../images/modding/meleechk-xoris.webp){ .center .bordered .floored width=80% }