...
![POE Gear](../images/affinity-farming/poe-gear.webp){ .center .bordered width=70% }
...
![Enemy Highlights](../images/affinity-farming/enemy-highlights.webp){ .center .bordered width=70% }
...
![on-call-gear](../images/affinity-farming/on-call-gear.webp){ .center .bordered width=70% }
...
![spawn 1](../images/affinity-farming/spawn1.webp){ .center .bordered width=70% }

![spawn 2](../images/affinity-farming/spawn2.webp){ .center .bordered width=70% }