...
- [Overview](#overview)
- [Fusing Gear](#fusing-gear)
- [How It Works](#how-it-works)
- [Why Fusion Order Matters](#why-fusion-order-matters)
- [Recommended Fusion Strategy](#recommended-fusion-strategy)
...
For Railjack gear, fusion improves stat and allows you to swap specialized traits depending on the item.
...
Fusing these two (starting with Kuva Zarr A) would give you back Kuva Zarr A with a 44% bonus of your chosen element (Heat or Tox). Since 40% is the higher value, the result is 1.1 x 40% = 44%. If you started the fusion from Copy B, you would end up breaking down Copy A and losing the 5 Forma invested.
...
If you were to fuse them one by one as you collected them, you'd end up with a progenitor bonus of 44%. However, if you waited and started fusing from your invested copy and your 44% Cold Kuva Tonkor, you'd end up with a final progenitor bonus of 60% (58.6 but anything over 58 rounds to 60).

This diagram shows both scenarios.

![Fusion Order Matters](../images/valence/valence.webp){ .center .bordered .floored width=70% }
...
2. Collect additional copies of until your highest progenitor bonus and number of extra copies match a row in the chart
