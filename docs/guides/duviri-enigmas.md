...
- **Statue 2** - 3 pushes
- **Statue 3** - 1 push
- **Statue 4** - Hack this console, the floor panels will open up, go down and activate the final statue. This statue will **not** activate until **all** 3 previous statues are facing the center of the island
