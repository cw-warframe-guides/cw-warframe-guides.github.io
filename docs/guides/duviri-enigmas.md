...
- **Statue 2** — 3 pushes
- **Statue 3** — 1 push
- **Statue 4** — Hack this console; the floor panels will open up, go down and activate the final statue. Note: you cannot do this until all 3 previous statues are facing the center of the island.

Once all 4 statues are activated/aligned, the gates underneath the island will retract!

> **Note:** If you rush it too fast, sometimes the puzzle won't spawn. Either reset or go back to the mainland, earn a decree, and come back — that usually fixes it.
...
4 discs are on the opposite side of the room from the 8 symbols. I recommend working on the regular sockets and the sockets with energy plates first, and then using those discs to work on the remaining sockets.
