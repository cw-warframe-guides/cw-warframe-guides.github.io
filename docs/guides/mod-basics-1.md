...
- [Overview](#overview)
- [Modding Fundamentals](#modding-fundamentals)
- [Mod Types & Rarities](#mod-types-rarities)
...
![Mod Details](../images/modding/basics1-mod.webp){ .center .bordered .floored width=75% }
...
The three standard rarity tiers. Many mods are earnable from enemy drops, but some have specific requirements to farm them. Drop locations can be found in the in-game Codex or on the [wiki](https://wiki.warframe.com/) which also has a lot of extra information about the mods and their drop rates. 
...
For the four login reward Prime mods, I recommend collecting them in this order:
Primed Shred (200), Primed Sure Footed (400), Primed Fury (600), and Primed Vigor (900). Primed Shred and Primed Fury can be swapped if you prefer melee combat, but Primed Fury has several alternatives or side-grades while Primed Shred does not.

&nbsp;

**Galvanized**

Galvanized mods are scaling variants of existing mods that stack up on kill to give stronger effects or new stat bonuses. You can purchase Galvanized mods from the Arbitrations Vendor for 20 Vitus Essence each. For more information on Arbitrations and how to optimize Vitus Essence farming, please check out the [Arbitrations](arbitrations.md) page. 
...
Riven mods are purple mods with randomized stats that are randomly assigned to a specific weapon family when unveiled. For example, if you unveil a Braton Riven, you can equip it on the Braton, MK1 Braton, Braton Prime, or Braton Vandal. To learn more about Riven mods, check out the [Riven Mods](rivens.md) guide.