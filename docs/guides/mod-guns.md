...
- [1. What Are My Base Damage Mods?](#1-what-are-my-base-damage-mods)
- [2. What's My Multishot Mod?](#2-whats-my-multishot-mod)
- [3. Is It a Viable Crit Weapon?](#3-is-it-a-viable-crit-weapon)
- [4. Is It a Viable Status Weapon?](#4-is-it-a-viable-status-weapon)
- [5. What QoL Mods Should I Use?](#5-what-qol-mods-should-i-use)
- [Example: Basic Baza Prime Build](#example-basic-baza-prime-build)
- [Example: SP Baza Prime Build](#example-sp-baza-prime-build)
...
Generally you'll want 1-2 sources of base damage. Any more than that and the diminishing returns you run into usually mean other mod types will be more effective. Check out the [Modding: Advanced Concepts](mod-adv.md) guide for more on diminishing returns. The most common sources are Serration (primaries), Hornet Strike (secondaries), and Point Blank (shotguns), along with Merciless and Deadhead Arcanes after unlocking Steel Path.
...
> **Note:** Not sure which elements to run? Check out the [Damage Types & Status Effects](mod-damage.md) guide and check out the status effects and tips sections.
...
![Baza SP](../images/modding/gunchk-baza-sp.webp){ .center .bordered .floored width=80% }